<x-app-layout>
    ...
    <style>
        ...
        .comment-scroll-box {
            max-height: 100px;
            /* 縦の最大高さを150px（およそ5〜6行分）に制限 */
            overflow-y: auto;
            /* 150pxを超えたら自動で縦スクロールバーを表示 */
            overflow-x: hidden;
            /* 横スクロールは出さずに自動折り返しさせる */
            padding-right: 5px;
            /* スクロールバーと文字が被らないように隙間をあける */
            margin-top: 5px;
        }
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900">
                ...
                <div class="section border border-gray-200 p-6 rounded-lg bg-gray-50">
                ...
                <div class="section">
                    ...
                    <div class="review-box">
                        ...
                        <div class="more-btn-area" id="more-btn-area"
                            style="{{ $book->reviews->isEmpty() ? 'display:none;' : '' }}">
                            <button type="button" id="more-btn" class="more-btn"
                                onclick="toggleReviews()">↓もっと見る</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function toggleFormDisabled(isDisabled) {
            ...
            const inputs = document.querySelectorAll('#review-form input, #review-form button, #review-form textarea');
